    ...
    if (stream) {
      setFormData({
        ...
        ...(protocol === 'icecast' && {
          ...
          password: '',
          hasPassword: Boolean((stream as IcecastSource).hasPassword),
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder={formData.hasPassword ? "•••••••• (inchangé si vide)" : undefined}
                    required={!stream || !formData.hasPassword}
                  />
                </div>
              </div>
              <div>
